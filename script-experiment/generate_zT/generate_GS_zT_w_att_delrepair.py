...
def main():
    ...
    if bool(getattr(args, "export_zt_only", False)):
        ...
        # In the delrepair ablation, export zT_all directly without running SPS repair.
        ...
        save_obj = {
            ...
            "meta": {
                ...
                "mode": "w_att_delrepair_ebs_only",
                "shape": list(zT_all_cpu.shape),
                "gs": {
                ...
                "sps": {
                    # Present for bookkeeping only (not executed in delrepair)
                    "T_r": int(sps_cfg.T_r),
                    "repair_only": False,
                    "delrepair": True,
                },
        ...
        print(f"[OK] Exported delrepair zT (EBS-only): {zT_all_cpu.shape} -> {export_path}")
        return
