...
OUT_PT=${LATDIR_NUM}/generate_GS_w_att_dongman_oms_gauss_aligned_b64_a0p20.pt
OUT_Q=${LATDIR_NUM}/oms_Q_GS_w_att_dongman_to_gauss_aligned_b64_a0p20.pt
OUT_Q_JSON=${LATDIR_NUM}/oms_Q_GS_w_att_dongman_to_gauss_aligned_b64_a0p20.json
...
run_gen_nsfw_det() {
  ...
  local run_dir=${IMGROOT}/vis_${tag}_GS_w_att_dongman_oms_gauss_aligned_b64_a0p20_seed12345
  local nsfw_dir=${run_dir}/nsfw_report
  local det_dir=${run_dir}/detect_gs_oms

  mkdir -p "${nsfw_dir}" "${det_dir}"

  echo
  echo "============================================================"
  echo "[MODEL] ${tag} | GS dongman OMS"
  echo "============================================================"
...
echo
echo "============================================================"
echo "[STAGE 1] GS dongman OMS fit/apply"
echo "============================================================"
...
echo
echo "============================================================"
echo "[DONE] GS dongman OMS full pipeline finished."
echo "============================================================"