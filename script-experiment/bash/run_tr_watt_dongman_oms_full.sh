...
OUT_PT=${LATDIR_NUM}/generate_TR_w_att_dongman_oms_gauss_aligned_b64_a0p20.pt
OUT_Q=${LATDIR_NUM}/oms_Q_TR_w_att_dongman_to_gauss_aligned_b64_a0p20.pt
OUT_Q_JSON=${LATDIR_NUM}/oms_Q_TR_w_att_dongman_to_gauss_aligned_b64_a0p20.json
...
run_gen_nsfw_det() {
  ...
  local run_dir=${IMGROOT}/vis_${tag}_TR_w_att_dongman_oms_gauss_aligned_b64_a0p20_seed12345
  local nsfw_dir=${run_dir}/nsfw_report
  local det_dir=${run_dir}/detect_tr_oms

  mkdir -p "${nsfw_dir}" "${det_dir}"

  echo
  echo "============================================================"
  echo "[MODEL] ${tag} | TR dongman OMS"
  echo "============================================================"
...
echo
echo "============================================================"
echo "[STAGE 1] TR dongman OMS fit/apply"
echo "============================================================"
...
echo
echo "============================================================"
echo "[DONE] TR dongman OMS full pipeline finished."
echo "============================================================"