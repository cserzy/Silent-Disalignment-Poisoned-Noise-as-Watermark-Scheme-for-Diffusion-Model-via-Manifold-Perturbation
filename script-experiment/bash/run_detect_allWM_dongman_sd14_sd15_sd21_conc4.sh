...
# ===== T2S meta: dongman align (best-effort auto-pick, edit if your filenames differ) =====
# 你如果当时生成 w / w_att 的 meta 文件名字不同，只需要改这两行即可。
META_T2S_W_ATT="${LATDIR}/generate_T2S_w_att_dongman_meta.pt"
META_T2S_W="${LATDIR}/generate_T2S_w_meta.pt"
...
# -----------------------------
TR_DIRS=(
  "${IMGROOT}/vis_sd14_TR_w_att_0_88_dongman_seed12345"
  "${IMGROOT}/vis_sd14_TR_w_dongman_seed12345"
  "${IMGROOT}/vis_sd15_TR_w_att_0_88_dongman_seed12345"
  "${IMGROOT}/vis_sd15_TR_w_dongman_seed12345"
  "${IMGROOT}/vis_sd21_TR_w_att_0_88_dongman_seed12345"
  "${IMGROOT}/vis_sd21_TR_w_dongman_seed12345"
)

GS_DIRS=(
  "${IMGROOT}/vis_sd14_GS_w_att_dongman_seed12345"
  "${IMGROOT}/vis_sd14_GS_w_dongman_seed12345"
  "${IMGROOT}/vis_sd15_GS_w_att_dongman_seed12345"
  "${IMGROOT}/vis_sd15_GS_w_dongman_seed12345"
  "${IMGROOT}/vis_sd21_GS_w_att_dongman_seed12345"
  "${IMGROOT}/vis_sd21_GS_w_dongman_seed12345"
)

T2S_DIRS=(
  "${IMGROOT}/vis_sd14_T2S_w_att_dongman_seed12345"
  "${IMGROOT}/vis_sd14_T2S_w_dongman_seed12345"
  "${IMGROOT}/vis_sd15_T2S_w_att_dongman_seed12345"
  "${IMGROOT}/vis_sd15_T2S_w_dongman_seed12345"
  "${IMGROOT}/vis_sd21_T2S_w_att_dongman_seed12345"
  "${IMGROOT}/vis_sd21_T2S_w_dongman_seed12345"
)
...
for i in "${!PRC_DIRS[@]}"; do
  ...
  # note: FIXED_ARGS are expanded by bash -lc, so keep as literals here
